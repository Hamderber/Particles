...
{
    public static int SizeOfTable_Isotopes = 0;

    public static void Build()
    {
        using (new TimedBlock("Building the database"))
        {
            ...
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-29
                symbol: "Cl",
                massNumber: 29,//p+n
                atomicNumber: 17,
                atomicMass: 29.01411,//atomic weight
                abundance: 0.0,
                massDefect: 13.143,//mass excess
                bindingEnergy: 7.159,
                halfLife: "20ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-30
                symbol: "Cl",
                massNumber: 30,//p+n
                atomicNumber: 17,
                atomicMass: 30.00477,//atomic weight
                abundance: 0.0,
                massDefect: 4.443,//mass excess
                bindingEnergy: 7.48,
                halfLife: "29.99999999998ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-31
                symbol: "Cl",
                massNumber: 31,//p+n
                atomicNumber: 17,
                atomicMass: 30.992413086,//atomic weight
                abundance: 0.0,
                massDefect: -7.067165,//mass excess
                bindingEnergy: 7.870261,
                halfLife: "150ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-32
                symbol: "Cl",
                massNumber: 32,//p+n
                atomicNumber: 17,
                atomicMass: 31.985689901,//atomic weight
                abundance: 0.0,
                massDefect: -13.32977,//mass excess
                bindingEnergy: 8.072251,
                halfLife: "298ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-33
                symbol: "Cl",
                massNumber: 33,//p+n
                atomicNumber: 17,
                atomicMass: 32.977451887,//atomic weight
                abundance: 0.0,
                massDefect: -21.003432,//mass excess
                bindingEnergy: 8.304758,
                halfLife: "2.511s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-34
                symbol: "Cl",
                massNumber: 34,//p+n
                atomicNumber: 17,
                atomicMass: 33.973762819,//atomic weight
                abundance: 0.0,
                massDefect: -24.439776,//mass excess
                bindingEnergy: 8.398961,
                halfLife: "1.5264s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-35
                symbol: "Cl",
                massNumber: 35,//p+n
                atomicNumber: 17,
                atomicMass: 34.968852682,//atomic weight
                abundance: 75.77,
                massDefect: -29.01354,//mass excess
                bindingEnergy: 8.520278,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-36
                symbol: "Cl",
                massNumber: 36,//p+n
                atomicNumber: 17,
                atomicMass: 35.968306981,//atomic weight
                abundance: 0.0,
                massDefect: -29.521857,//mass excess
                bindingEnergy: 8.521927,
                halfLife: "301243.0238458y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-37
                symbol: "Cl",
                massNumber: 37,//p+n
                atomicNumber: 17,
                atomicMass: 36.965902591,//atomic weight
                abundance: 24.23,
                massDefect: -31.761532,//mass excess
                bindingEnergy: 8.57028,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-38
                symbol: "Cl",
                massNumber: 38,//p+n
                atomicNumber: 17,
                atomicMass: 37.968010425,//atomic weight
                abundance: 0.0,
                massDefect: -29.798097,//mass excess
                bindingEnergy: 8.50548,
                halfLife: "37.23333333333m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-39
                symbol: "Cl",
                massNumber: 39,//p+n
                atomicNumber: 17,
                atomicMass: 38.968008164,//atomic weight
                abundance: 0.0,
                massDefect: -29.800203,//mass excess
                bindingEnergy: 8.494402,
                halfLife: "56.2m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-40
                symbol: "Cl",
                massNumber: 40,//p+n
                atomicNumber: 17,
                atomicMass: 39.970415472,//atomic weight
                abundance: 0.0,
                massDefect: -27.55781,//mass excess
                bindingEnergy: 8.427765,
                halfLife: "1.35m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-41
                symbol: "Cl",
                massNumber: 41,//p+n
                atomicNumber: 17,
                atomicMass: 40.970684525,//atomic weight
                abundance: 0.0,
                massDefect: -27.307189,//mass excess
                bindingEnergy: 8.412958,
                halfLife: "38.4s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-42
                symbol: "Cl",
                massNumber: 42,//p+n
                atomicNumber: 17,
                atomicMass: 41.973254804,//atomic weight
                abundance: 0.0,
                massDefect: -24.91299,//mass excess
                bindingEnergy: 8.347819,
                halfLife: "6.8s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-43
                symbol: "Cl",
                massNumber: 43,//p+n
                atomicNumber: 17,
                atomicMass: 42.974054403,//atomic weight
                abundance: 0.0,
                massDefect: -24.168168,//mass excess
                bindingEnergy: 8.324068,
                halfLife: "3.13s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-44
                symbol: "Cl",
                massNumber: 44,//p+n
                atomicNumber: 17,
                atomicMass: 43.978281071,//atomic weight
                abundance: 0.0,
                massDefect: -20.231052,//mass excess
                bindingEnergy: 8.228843,
                halfLife: "560ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-45
                symbol: "Cl",
                massNumber: 45,//p+n
                atomicNumber: 17,
                atomicMass: 44.980286886,//atomic weight
                abundance: 0.0,
                massDefect: -18.362647,//mass excess
                bindingEnergy: 8.183823,
                halfLife: "413ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-46
                symbol: "Cl",
                massNumber: 46,//p+n
                atomicNumber: 17,
                atomicMass: 45.98421004,//atomic weight
                abundance: 0.0,
                massDefect: -14.708253,//mass excess
                bindingEnergy: 8.101934,
                halfLife: "232ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-47
                symbol: "Cl",
                massNumber: 47,//p+n
                atomicNumber: 17,
                atomicMass: 46.98871,//atomic weight
                abundance: 0.0,
                massDefect: -10.517,//mass excess
                bindingEnergy: 8.012,
                halfLife: "101ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-48
                symbol: "Cl",
                massNumber: 48,//p+n
                atomicNumber: 17,
                atomicMass: 47.99495,//atomic weight
                abundance: 0.0,
                massDefect: -4.704,//mass excess
                bindingEnergy: 7.892,
                halfLife: "200ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-49
                symbol: "Cl",
                massNumber: 49,//p+n
                atomicNumber: 17,
                atomicMass: 49.00032,//atomic weight
                abundance: 0.0,
                massDefect: 0.298,//mass excess
                bindingEnergy: 7.794,
                halfLife: "170ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-50
                symbol: "Cl",
                massNumber: 50,//p+n
                atomicNumber: 17,
                atomicMass: 50.00784,//atomic weight
                abundance: 0.0,
                massDefect: 7.303,//mass excess
                bindingEnergy: 7.659,
                halfLife: "20.19773057245ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Chlorine",//Cl-51
                symbol: "Cl",
                massNumber: 51,//p+n
                atomicNumber: 17,
                atomicMass: 51.01449,//atomic weight
                abundance: 0.0,
                massDefect: 13.497,//mass excess
                bindingEnergy: 7.546,
                halfLife: "200ns"
            ));
            #endregion
            ...
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-30
                symbol: "Ar",
                massNumber: 30,//p+n
                atomicNumber: 18,
                atomicMass: 30.02156,//atomic weight
                abundance: 0.0,
                massDefect: 20.083,//mass excess
                bindingEnergy: 6.932,
                halfLife: "20ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-31
                symbol: "Ar",
                massNumber: 31,//p+n
                atomicNumber: 18,
                atomicMass: 31.012123,//atomic weight
                abundance: 0.0,
                massDefect: 11.293,//mass excess
                bindingEnergy: 7.253,
                halfLife: "14.4ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-32
                symbol: "Ar",
                massNumber: 32,//p+n
                atomicNumber: 18,
                atomicMass: 31.997637984,//atomic weight
                abundance: 0.0,
                massDefect: -2.200204,//mass excess
                bindingEnergy: 7.700003,
                halfLife: "98.10326278045ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-33
                symbol: "Ar",
                massNumber: 33,//p+n
                atomicNumber: 18,
                atomicMass: 32.989925709,//atomic weight
                abundance: 0.0,
                massDefect: -9.384141,//mass excess
                bindingEnergy: 7.92895,
                halfLife: "173ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-34
                symbol: "Ar",
                massNumber: 34,//p+n
                atomicNumber: 18,
                atomicMass: 33.980271244,//atomic weight
                abundance: 0.0,
                massDefect: -18.377217,//mass excess
                bindingEnergy: 8.19764,
                halfLife: "845ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-35
                symbol: "Ar",
                massNumber: 35,//p+n
                atomicNumber: 18,
                atomicMass: 34.975257585,//atomic weight
                abundance: 0.0,
                massDefect: -23.047411,//mass excess
                bindingEnergy: 8.327465,
                halfLife: "1.775s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-36
                symbol: "Ar",
                massNumber: 36,//p+n
                atomicNumber: 18,
                atomicMass: 35.967545105,//atomic weight
                abundance: 0.3365,
                massDefect: -30.23154,//mass excess
                bindingEnergy: 8.519909,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-37
                symbol: "Ar",
                massNumber: 37,//p+n
                atomicNumber: 18,
                atomicMass: 36.96677632,//atomic weight
                abundance: 0.0,
                massDefect: -30.947659,//mass excess
                bindingEnergy: 8.527139,
                halfLife: "34.95d"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-38
                symbol: "Ar",
                massNumber: 38,//p+n
                atomicNumber: 18,
                atomicMass: 37.962732394,//atomic weight
                abundance: 0.0632,
                massDefect: -34.714551,//mass excess
                bindingEnergy: 8.614273,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-39
                symbol: "Ar",
                massNumber: 39,//p+n
                atomicNumber: 18,
                atomicMass: 38.964313231,//atomic weight
                abundance: 0.0,
                massDefect: -33.242011,//mass excess
                bindingEnergy: 8.562593,
                halfLife: "269.2161339422y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-40
                symbol: "Ar",
                massNumber: 40,//p+n
                atomicNumber: 18,
                atomicMass: 39.96238312251,//atomic weight
                abundance: 99.6003,
                massDefect: -35.03989602,//mass excess
                bindingEnergy: 8.595259,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-41
                symbol: "Ar",
                massNumber: 41,//p+n
                atomicNumber: 18,
                atomicMass: 40.964500611,//atomic weight
                abundance: 0.0,
                massDefect: -33.067467,//mass excess
                bindingEnergy: 8.534371,
                halfLife: "1.826833333333h"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-42
                symbol: "Ar",
                massNumber: 42,//p+n
                atomicNumber: 18,
                atomicMass: 41.963045736,//atomic weight
                abundance: 0.0,
                massDefect: -34.422675,//mass excess
                bindingEnergy: 8.555613,
                halfLife: "32.97818366312y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-43
                symbol: "Ar",
                massNumber: 43,//p+n
                atomicNumber: 18,
                atomicMass: 42.965636056,//atomic weight
                abundance: 0.0,
                massDefect: -32.009808,//mass excess
                bindingEnergy: 8.488237,
                halfLife: "5.366666666667m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-44
                symbol: "Ar",
                massNumber: 44,//p+n
                atomicNumber: 18,
                atomicMass: 43.964924033,//atomic weight
                abundance: 0.0,
                massDefect: -32.673053,//mass excess
                bindingEnergy: 8.493836,
                halfLife: "11.87m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-45
                symbol: "Ar",
                massNumber: 45,//p+n
                atomicNumber: 18,
                atomicMass: 44.968039956,//atomic weight
                abundance: 0.0,
                massDefect: -29.770589,//mass excess
                bindingEnergy: 8.419947,
                halfLife: "21.48s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-46
                symbol: "Ar",
                massNumber: 46,//p+n
                atomicNumber: 18,
                atomicMass: 45.968094129,//atomic weight
                abundance: 0.0,
                massDefect: -29.720127,//mass excess
                bindingEnergy: 8.411271,
                halfLife: "8.4s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-47
                symbol: "Ar",
                massNumber: 47,//p+n
                atomicNumber: 18,
                atomicMass: 46.972186792,//atomic weight
                abundance: 0.0,
                massDefect: -25.907836,//mass excess
                bindingEnergy: 8.322926,
                halfLife: "1.23s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-48
                symbol: "Ar",
                massNumber: 48,//p+n
                atomicNumber: 18,
                atomicMass: 47.97454,//atomic weight
                abundance: 0.0,
                massDefect: -23.716,//mass excess
                bindingEnergy: 8.272,
                halfLife: "475ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-49
                symbol: "Ar",
                massNumber: 49,//p+n
                atomicNumber: 18,
                atomicMass: 48.98052,//atomic weight
                abundance: 0.0,
                massDefect: -18.146,//mass excess
                bindingEnergy: 8.154,
                halfLife: "170ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-50
                symbol: "Ar",
                massNumber: 50,//p+n
                atomicNumber: 18,
                atomicMass: 49.98443,//atomic weight
                abundance: 0.0,
                massDefect: -14.503,//mass excess
                bindingEnergy: 8.08,
                halfLife: "170ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-51
                symbol: "Ar",
                massNumber: 51,//p+n
                atomicNumber: 18,
                atomicMass: 50.99163,//atomic weight
                abundance: 0.0,
                massDefect: -7.797,//mass excess
                bindingEnergy: 7.948,
                halfLife: "200ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-52
                symbol: "Ar",
                massNumber: 52,//p+n
                atomicNumber: 18,
                atomicMass: 51.99678,//atomic weight
                abundance: 0.0,
                massDefect: -2.999,//mass excess
                bindingEnergy: 7.858,
                halfLife: "10ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Argon",//Ar-53
                symbol: "Ar",
                massNumber: 53,//p+n
                atomicNumber: 18,
                atomicMass: 53.00494,//atomic weight
                abundance: 0.0,
                massDefect: 4.602,//mass excess
                bindingEnergy: 7.719,
                halfLife: "3ms"
            ));
            #endregion
            ...
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-33
                symbol: "K",
                massNumber: 33,//p+n
                atomicNumber: 19,
                atomicMass: 33.00726,//atomic weight
                abundance: 0.0,
                massDefect: 6.763,//mass excess
                bindingEnergy: 7.416,
                halfLife: "25ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-34
                symbol: "K",
                massNumber: 34,//p+n
                atomicNumber: 19,
                atomicMass: 33.99841,//atomic weight
                abundance: 0.0,
                massDefect: -1.481,//mass excess
                bindingEnergy: 7.678,
                halfLife: "25ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-35
                symbol: "K",
                massNumber: 35,//p+n
                atomicNumber: 19,
                atomicMass: 34.988009692,//atomic weight
                abundance: 0.0,
                massDefect: -11.1689,//mass excess
                bindingEnergy: 7.965726,
                halfLife: "178ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-36
                symbol: "K",
                massNumber: 36,//p+n
                atomicNumber: 19,
                atomicMass: 35.981292235,//atomic weight
                abundance: 0.0,
                massDefect: -17.426171,//mass excess
                bindingEnergy: 8.142472,
                halfLife: "342ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-37
                symbol: "K",
                massNumber: 37,//p+n
                atomicNumber: 19,
                atomicMass: 36.973375889,//atomic weight
                abundance: 0.0,
                massDefect: -24.800199,//mass excess
                bindingEnergy: 8.339847,
                halfLife: "1.226ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-38
                symbol: "K",
                massNumber: 38,//p+n
                atomicNumber: 19,
                atomicMass: 37.969081184,//atomic weight
                abundance: 0.0,
                massDefect: -28.800691,//mass excess
                bindingEnergy: 8.438057,
                halfLife: "7.636666666667m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-39
                symbol: "K",
                massNumber: 39,//p+n
                atomicNumber: 19,
                atomicMass: 38.963706679,//atomic weight
                abundance: 93.2581,
                massDefect: -33.807011,//mass excess
                bindingEnergy: 8.55702,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-40
                symbol: "K",
                massNumber: 40,//p+n
                atomicNumber: 19,
                atomicMass: 39.963998475,//atomic weight
                abundance: 0.0117,
                massDefect: -33.535205,//mass excess
                bindingEnergy: 8.538083,
                halfLife: "1.248e9y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-41
                symbol: "K",
                massNumber: 41,//p+n
                atomicNumber: 19,
                atomicMass: 40.961825762,//atomic weight
                abundance: 6.7302,
                massDefect: -35.559074,//mass excess
                bindingEnergy: 8.576061,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-42
                symbol: "K",
                massNumber: 42,//p+n
                atomicNumber: 19,
                atomicMass: 41.96240281,//atomic weight
                abundance: 0.0,
                massDefect: -35.021556,//mass excess
                bindingEnergy: 8.551245,
                halfLife: "12.321h"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-43
                symbol: "K",
                massNumber: 43,//p+n
                atomicNumber: 19,
                atomicMass: 42.96071554,//atomic weight
                abundance: 0.0,
                massDefect: -36.593239,//mass excess
                bindingEnergy: 8.576635,
                halfLife: "22.30555555556h"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-44
                symbol: "K",
                massNumber: 44,//p+n
                atomicNumber: 19,
                atomicMass: 43.961556804,//atomic weight
                abundance: 0.0,
                massDefect: -35.809606,//mass excess
                bindingEnergy: 8.54734,
                halfLife: "22.13333333333m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-45
                symbol: "K",
                massNumber: 45,//p+n
                atomicNumber: 19,
                atomicMass: 44.960699493,//atomic weight
                abundance: 0.0,
                massDefect: -36.608186,//mass excess
                bindingEnergy: 8.554508,
                halfLife: "17.81m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-46
                symbol: "K",
                massNumber: 46,//p+n
                atomicNumber: 19,
                atomicMass: 45.961976864,//atomic weight
                abundance: 0.0,
                massDefect: -35.418323,//mass excess
                bindingEnergy: 8.518137,
                halfLife: "1.75m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-47
                symbol: "K",
                massNumber: 47,//p+n
                atomicNumber: 19,
                atomicMass: 46.961678473,//atomic weight
                abundance: 0.0,
                massDefect: -35.696272,//mass excess
                bindingEnergy: 8.514544,
                halfLife: "17.5s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-48
                symbol: "K",
                massNumber: 48,//p+n
                atomicNumber: 19,
                atomicMass: 47.965513535,//atomic weight
                abundance: 0.0,
                massDefect: -32.123935,//mass excess
                bindingEnergy: 8.430887,
                halfLife: "6.8s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-49
                symbol: "K",
                massNumber: 49,//p+n
                atomicNumber: 19,
                atomicMass: 48.967450928,//atomic weight
                abundance: 0.0,
                massDefect: -30.319265,//mass excess
                bindingEnergy: 8.386719,
                halfLife: "1.26s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-50
                symbol: "K",
                massNumber: 50,//p+n
                atomicNumber: 19,
                atomicMass: 49.972783355,//atomic weight
                abundance: 0.0,
                massDefect: -25.352141,//mass excess
                bindingEnergy: 8.281068,
                halfLife: "472ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-51
                symbol: "K",
                massNumber: 51,//p+n
                atomicNumber: 19,
                atomicMass: 50.97638,//atomic weight
                abundance: 0.0,
                massDefect: -22.002,//mass excess
                bindingEnergy: 8.211,
                halfLife: "365ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-52
                symbol: "K",
                massNumber: 52,//p+n
                atomicNumber: 19,
                atomicMass: 51.98261,//atomic weight
                abundance: 0.0,
                massDefect: -16.199,//mass excess
                bindingEnergy: 8.097,
                halfLife: "105ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-53
                symbol: "K",
                massNumber: 53,//p+n
                atomicNumber: 19,
                atomicMass: 52.98712,//atomic weight
                abundance: 0.0,
                massDefect: -11.998,//mass excess
                bindingEnergy: 8.017,
                halfLife: "30ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-54
                symbol: "K",
                massNumber: 54,//p+n
                atomicNumber: 19,
                atomicMass: 53.9942,//atomic weight
                abundance: 0.0,
                massDefect: -5.403,//mass excess
                bindingEnergy: 7.896,
                halfLife: "10ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Potassium",//K-55
                symbol: "K",
                massNumber: 55,//p+n
                atomicNumber: 19,
                atomicMass: 54.99971,//atomic weight
                abundance: 0.0,
                massDefect: -0.27,//mass excess
                bindingEnergy: 7.806,
                halfLife: "3ms"
            ));
            #endregion
            ...
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-34
                symbol: "Ca",
                massNumber: 34,//p+n
                atomicNumber: 20,
                atomicMass: 34.01412,//atomic weight
                abundance: 0.0,
                massDefect: 13.153,//mass excess
                bindingEnergy: 7.224,
                halfLife: "35.00000000001ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-35
                symbol: "Ca",
                massNumber: 35,//p+n
                atomicNumber: 20,
                atomicMass: 35.00494,//atomic weight
                abundance: 0.0,
                massDefect: 4.602,//mass excess
                bindingEnergy: 7.493,
                halfLife: "25.7ms"
            ...
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-36
                symbol: "Ca",
                massNumber: 36,//p+n
                atomicNumber: 20,
                atomicMass: 35.993087063,//atomic weight
                abundance: 0.0,
                massDefect: -6.439359,//mass excess
                bindingEnergy: 7.815551,
                halfLife: "102ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-37
                symbol: "Ca",
                massNumber: 37,//p+n
                atomicNumber: 20,
                atomicMass: 36.985870269,//atomic weight
                abundance: 0.0,
                massDefect: -13.16176,//mass excess
                bindingEnergy: 8.00415,
                halfLife: "181.1ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-38
                symbol: "Ca",
                massNumber: 38,//p+n
                atomicNumber: 20,
                atomicMass: 37.976318452,//atomic weight
                abundance: 0.0,
                massDefect: -22.05922,//mass excess
                bindingEnergy: 8.240062,
                halfLife: "440ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-39
                symbol: "Ca",
                massNumber: 39,//p+n
                atomicNumber: 20,
                atomicMass: 38.970719725,//atomic weight
                abundance: 0.0,
                massDefect: -27.2744,//mass excess
                bindingEnergy: 8.369457,
                halfLife: "859.6ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-40
                symbol: "Ca",
                massNumber: 40,//p+n
                atomicNumber: 20,
                atomicMass: 39.962590983,//atomic weight
                abundance: 96.94,
                massDefect: -34.846275,//mass excess
                bindingEnergy: 8.551301,
                halfLife: "3e21y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-41
                symbol: "Ca",
                massNumber: 41,//p+n
                atomicNumber: 20,
                atomicMass: 40.962278062,//atomic weight
                abundance: 0.0,
                massDefect: -35.137759,//mass excess
                bindingEnergy: 8.546703,
                halfLife: "102105.5301877y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-42
                symbol: "Ca",
                massNumber: 42,//p+n
                atomicNumber: 20,
                atomicMass: 41.958618014,//atomic weight
                abundance: 0.647,
                massDefect: -38.547072,//mass excess
                bindingEnergy: 8.616559,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-43
                symbol: "Ca",
                massNumber: 43,//p+n
                atomicNumber: 20,
                atomicMass: 42.958766628,//atomic weight
                abundance: 0.135,
                massDefect: -38.408639,//mass excess
                bindingEnergy: 8.600659,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-44
                symbol: "Ca",
                massNumber: 44,//p+n
                atomicNumber: 20,
                atomicMass: 43.955481754,//atomic weight
                abundance: 2.09,
                massDefect: -41.468479,//mass excess
                bindingEnergy: 8.65817,
                halfLife: "Stable"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-45
                symbol: "Ca",
                massNumber: 45,//p+n
                atomicNumber: 20,
                atomicMass: 44.956186566,//atomic weight
                abundance: 0.0,
                massDefect: -40.81195,//mass excess
                bindingEnergy: 8.63054,
                halfLife: "162.61d"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-46
                symbol: "Ca",
                massNumber: 46,//p+n
                atomicNumber: 20,
                atomicMass: 45.953692587,//atomic weight
                abundance: 0.004,
                massDefect: -43.135077,//mass excess
                bindingEnergy: 8.668885,
                halfLife: "2.8e15y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-47
                symbol: "Ca",
                massNumber: 47,//p+n
                atomicNumber: 20,
                atomicMass: 46.954546006,//atomic weight
                abundance: 0.0,
                massDefect: -42.340123,//mass excess
                bindingEnergy: 8.639257,
                halfLife: "4.53587962963d"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-48
                symbol: "Ca",
                massNumber: 48,//p+n
                atomicNumber: 20,
                atomicMass: 47.952534177,//atomic weight
                abundance: 0.187,
                massDefect: -44.214129,//mass excess
                bindingEnergy: 8.666467,
                halfLife: "1.9e19y"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-49
                symbol: "Ca",
                massNumber: 49,//p+n
                atomicNumber: 20,
                atomicMass: 48.955674148,//atomic weight
                abundance: 0.0,
                massDefect: -41.289265,//mass excess
                bindingEnergy: 8.59463,
                halfLife: "8.718333333333m"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-50
                symbol: "Ca",
                massNumber: 50,//p+n
                atomicNumber: 20,
                atomicMass: 49.957518962,//atomic weight
                abundance: 0.0,
                massDefect: -39.570832,//mass excess
                bindingEnergy: 8.549795,
                halfLife: "13.9s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-51
                symbol: "Ca",
                massNumber: 51,//p+n
                atomicNumber: 20,
                atomicMass: 50.961499214,//atomic weight
                abundance: 0.0,
                massDefect: -35.863251,//mass excess
                bindingEnergy: 8.467716,
                halfLife: "10s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-52
                symbol: "Ca",
                massNumber: 52,//p+n
                atomicNumber: 20,
                atomicMass: 51.9651,//atomic weight
                abundance: 0.0,
                massDefect: -32.509141,//mass excess
                bindingEnergy: 8.39559,
                halfLife: "4.6s"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-53
                symbol: "Ca",
                massNumber: 53,//p+n
                atomicNumber: 20,
                atomicMass: 52.97005,//atomic weight
                abundance: 0.0,
                massDefect: -27.898,//mass excess
                bindingEnergy: 8.302,
                halfLife: "90ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-54
                symbol: "Ca",
                massNumber: 54,//p+n
                atomicNumber: 20,
                atomicMass: 53.97435,//atomic weight
                abundance: 0.0,
                massDefect: -23.893,//mass excess
                bindingEnergy: 8.224,
                halfLife: "300ns"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-55
                symbol: "Ca",
                massNumber: 55,//p+n
                atomicNumber: 20,
                atomicMass: 54.98055,//atomic weight
                abundance: 0.0,
                massDefect: -18.118,//mass excess
                bindingEnergy: 8.116,
                halfLife: "30ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-56
                symbol: "Ca",
                massNumber: 56,//p+n
                atomicNumber: 20,
                atomicMass: 55.98557,//atomic weight
                abundance: 0.0,
                massDefect: -13.441,//mass excess
                bindingEnergy: 8.032,
                halfLife: "10ms"
            ));
            elementsToAdd.Add(
            new Particle(
                elementName: "Calcium",//Ca-57
                symbol: "Ca",
                massNumber: 57,//p+n
                atomicNumber: 20,
                atomicMass: 56.992356,//atomic weight
                abundance: 0.0,
                massDefect: -7.12,//mass excess
                bindingEnergy: 7.922,
                halfLife: "5ms"
            ));
            #endregion
            ...
            SizeOfTable_Isotopes = elementsToAdd.Count;
            DataBaseInteract.UpdateIsotopeData(elementsToAdd);
            elementsToAdd.Clear();
        }
    }
}